...
import { IAboutUsGallery } from "../interface/about.interface";

type Props = {
  data: IAboutUsGallery;
};
    ...
    <div className="overflow-hidden">
      <div className="pb-16 md:pb-24 padding">
        <div className="flex flex-col items-center text-center space-y-4">
          ...
          <p
            className="text-text-400 typography-paragraph-regular text-[16px] leading-[150%] font-medium max-w-7xl"
