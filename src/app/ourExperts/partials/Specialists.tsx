    ...
    <section className="py-20 px-20  ">
      ...
      <div className="my-10 grid grid-cols-4 gap-y-10 gap-x-10">
        {ivfTeamData?.map((items) => (
          ...
          >
            <div
              className="w-[290px] aspect-[290/336]  relative rounded-tl-[50px] rounded-br-[50px] overflow-hidden   "
              style={{
                background:
      ...
      hoveredCardId === items.id ? "opacity-100 visible" : "opacity-0 invisible"
              ...
              >
                ...
                <div className="flex items-center  text-nowrap">
                  <button className="typography-caption px-5 py-2 font-medium text-text-400 border rounded-full border-text-400">
                    Consult Now
                  </button>
                  <button className="typography-caption px-5 py-2 font-medium text-text-400 ">
                    Call Back Request
                  </button>
                </div>
              </div>
