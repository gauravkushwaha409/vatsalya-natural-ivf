...
const Cycle: React.FC<CycleLengthSelectorProps> = ({
  ...
  return (
    <div className="flex w-auto h-fit flex-col gap-2 items-start shadow-md p-5 rounded-lg">
      ...
      <button className="hover:bg-secondary-700 bg-secondary-500  px-11 py-2 border-[0.4px] border-secondary-100 rounded-full font-semibold typography-paragraph-regular transition-colors duration-300 typography-h4 cursor-pointer text-white w-full mt-5">
        Result
      </button>
    </div>
  );
