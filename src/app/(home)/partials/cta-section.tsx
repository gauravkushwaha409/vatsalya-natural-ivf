...
const CTA = () => {
  return (
    <div className="py-9 lg:py-[72px] bg-[#ffd2ce] ">
      <div className="max-w-[1440px] px-4 lg:px-0 mx-auto flex flex-col  gap-8 lg:gap-0 lg:flex-row lg:items-center justify-between ">
        <div className="w-full lg:w-1/2 ">
          <p className="text-gray-800 text-2xl lg:text-[36px] font-semibold mt-2 ">
           Connect With Us
          </p>
          <div className="flex items-start mt-4 lg:mt-8">
