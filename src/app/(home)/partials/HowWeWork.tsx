      ...
      <div className="relative">
        ...
        <div className="top-0 md:top-12 right-1 md:right-[9%] -z-10 absolute pointer-events-none">
          <Image
            ...
            width={500}
            height={500}
            className="size-[5rem] md:size-[8rem] lg:size-[15rem] object-contain"
          />
        </div>
      </div>
      ...
      <div className="relative lg:flex flex-col md:gap-32 px-6 sm:px-10 md:px-20 lg:px-40 divide-y md:divide-y-0">
        {data?.HowWorksDetails?.map(
          (step: IHowWeWorkHowWorksDetail, index: number) => (
            <div
              className={`flex flex-col-reverse gap-y-6 gap-x-8 lg:gap-x-24 pb-4 mb-4 ${
            ...
            >
              ...
              >
                ...
                <p
                  className={`font-medium text-text-400 typography-paragraph-regular  ${
                    index % 2 === 0 ? "md:text-left" : "md:text-right"
                  }`}
