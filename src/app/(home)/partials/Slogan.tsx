  ...
  return (
    <div className="relative flex justify-center items-center  font-semibold text-center leading-[150%]">
      <Image
        ...
        width={200}
        height={200}
        className="absolute -top-20 left-44 -rotate-[110deg] -z-10 "
      />
      <AnimatingText className="justify-center mx-auto lg:mb-20 max-w-[62.375rem] font-semibold text-text-300 typography-h4 leading-8">
        {` " ${cleanText} " `}
      </AnimatingText>
    </div>
  );
