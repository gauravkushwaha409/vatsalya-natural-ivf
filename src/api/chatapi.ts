...
import { BASE_CHATBOT_URL } from "./endpoints";
...
export const chatApiSlice = createApi({
  ...
  tagTypes: ["Data"],
  endpoints: (builder) => ({
    chatGetData: builder.query<any, IGetDataArgs>({
      query: ({ url, params }) => ({
        url,
        method: "GET",
        params,
    ...
    chatPostData: builder.mutation<any, IPostDataArgs>({
    ...
    chatUpdateData: builder.mutation<any, IUpdateDataArgs>({
      query: ({ url, data }) => ({
        url,
        method: "PUT",
        body: data,
    ...
    chatDeleteData: builder.mutation<any, IDeleteDataArgs>({
      query: ({ url, body }) => ({
        url,
        method: "DELETE",
        body,
    ...
    chatGetAllData: builder.infiniteQuery<
...
export const {
  useChatGetDataQuery,
  useChatPostDataMutation,
  useChatUpdateDataMutation,
  useChatDeleteDataMutation,
  useChatGetAllDataInfiniteQuery,
} = chatApiSlice;
